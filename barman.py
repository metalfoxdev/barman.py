...
while(True):
    ...
    if age > 17:
        ...
        selections = {"1":"beer", "2":"wine", "3": "lagar"}
        ...
        while va == False:
            ...
            if branch == 1:
                print(mkopt({"1": "Hit the person beside you with your bottle of beer", "2":"Smash your beer bottle and ask for another", "3":"Drink your beer and leave"}))
            elif branch == 2:
